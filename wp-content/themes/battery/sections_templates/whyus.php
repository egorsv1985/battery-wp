	...
	<div class="whyus__container">
		...
		<div class="whyus__rcolumn">
			<div class="whyus__list-item">
				<img src="<?php echo get_template_directory_uri(); ?>/img/icons/blueCircle.svg" alt="Circle" class="whyus__circle" />
			...
			<div class="whyus__important important">
				<img src="<?php echo get_template_directory_uri(); ?>/img/icons/attention.svg" alt="Circle" class="important__icon" />
