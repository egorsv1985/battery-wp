		...
		<div class="contact__info">
			<div class="contact__content">
				...
				<div class="contact__item">
					...
					<p class="contact__text"> <?php echo esc_html(get_theme_mod('address')); ?></p>
				...
				<div class="contact__item">
					...
					?>
					<a href="tel:+<?php echo $phone_clean; ?>" class="contact__text"><?php echo esc_html(get_theme_mod('phone')); ?></a>
				</div>
				<div class="contact__item">
					<img src="<?php echo get_template_directory_uri(); ?>/img/icons/black_mail.svg" alt="" class="contact__icon" />
					<a href="mailto: <?php echo esc_html(get_theme_mod('emails')); ?>" class="contact__text"><?php echo esc_html(get_theme_mod('emails')); ?></a>
				</div>
			</div>
			<div class="contact__map">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3051.399515416171!2d-76.05992839999999!3d40.11109929999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c640205bf47fb3%3A0x66dbd64e83bd8a47!2s150%20Earland%20Dr%20Building%205%2C%20Suite%205D%2C%20New%20Holland%2C%20PA%2017557%2C%20%D0%A1%D0%A8%D0%90!5e0!3m2!1sru!2sby!4v1694690887691!5m2!1sru!2sby" style="border: 0" class="contact__iframe" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</div>
		</div>
